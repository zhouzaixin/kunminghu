...
module FastArbiter_29(
  ...
  assign io_out_bits_set =
    ...
    | (chosenOH[10] ? io_in_10_bits_set : 8'h0)
    | (chosenOH[11] ? io_in_11_bits_set : 8'h0)
    | (chosenOH[12] ? io_in_12_bits_set : 8'h0)
    | (chosenOH[13] ? io_in_13_bits_set : 8'h0)
    | (chosenOH[14] ? io_in_14_bits_set : 8'h0)
    | (chosenOH[15] ? io_in_15_bits_set : 8'h0);
  assign io_out_bits_way =
    (chosenOH[0] ? io_in_0_bits_way : 4'h0) | (chosenOH[1] ? io_in_1_bits_way : 4'h0)
    | (chosenOH[2] ? io_in_2_bits_way : 4'h0) | (chosenOH[3] ? io_in_3_bits_way : 4'h0)
    | (chosenOH[4] ? io_in_4_bits_way : 4'h0) | (chosenOH[5] ? io_in_5_bits_way : 4'h0)
    | (chosenOH[6] ? io_in_6_bits_way : 4'h0) | (chosenOH[7] ? io_in_7_bits_way : 4'h0)
    | (chosenOH[8] ? io_in_8_bits_way : 4'h0) | (chosenOH[9] ? io_in_9_bits_way : 4'h0)
    | (chosenOH[10] ? io_in_10_bits_way : 4'h0)
    | (chosenOH[11] ? io_in_11_bits_way : 4'h0)
    | (chosenOH[12] ? io_in_12_bits_way : 4'h0)
    | (chosenOH[13] ? io_in_13_bits_way : 4'h0)
    | (chosenOH[14] ? io_in_14_bits_way : 4'h0)
    | (chosenOH[15] ? io_in_15_bits_way : 4'h0);
  assign io_out_bits_data_0_state =
    (chosenOH[0] ? io_in_0_bits_data_0_state : 2'h0)
    | (chosenOH[1] ? io_in_1_bits_data_0_state : 2'h0)
    | (chosenOH[2] ? io_in_2_bits_data_0_state : 2'h0)
    | (chosenOH[3] ? io_in_3_bits_data_0_state : 2'h0)
    | (chosenOH[4] ? io_in_4_bits_data_0_state : 2'h0)
    | (chosenOH[5] ? io_in_5_bits_data_0_state : 2'h0)
    | (chosenOH[6] ? io_in_6_bits_data_0_state : 2'h0)
    | (chosenOH[7] ? io_in_7_bits_data_0_state : 2'h0)
    | (chosenOH[8] ? io_in_8_bits_data_0_state : 2'h0)
    | (chosenOH[9] ? io_in_9_bits_data_0_state : 2'h0)
    | (chosenOH[10] ? io_in_10_bits_data_0_state : 2'h0)
    | (chosenOH[11] ? io_in_11_bits_data_0_state : 2'h0)
    | (chosenOH[12] ? io_in_12_bits_data_0_state : 2'h0)
    | (chosenOH[13] ? io_in_13_bits_data_0_state : 2'h0)
    | (chosenOH[14] ? io_in_14_bits_data_0_state : 2'h0)
    | (chosenOH[15] ? io_in_15_bits_data_0_state : 2'h0);
endmodule
