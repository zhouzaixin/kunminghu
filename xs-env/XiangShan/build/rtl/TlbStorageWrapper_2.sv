...
module TlbStorageWrapper_2(
  ...
  wire [5:0]  _page_sttlb_storage_fa_io_access_0_touch_ways_bits;
  wire        _page_sttlb_storage_fa_io_access_1_touch_ways_valid;
  wire [5:0]  _page_sttlb_storage_fa_io_access_1_touch_ways_bits;
  reg  [46:0] refill_idx_state_reg;
  wire [14:0] _refill_idx_state_reg_T_52 =
    _page_sttlb_storage_fa_io_access_0_touch_ways_bits[5]
      ? {~(_page_sttlb_storage_fa_io_access_0_touch_ways_bits[3]),
         _page_sttlb_storage_fa_io_access_0_touch_ways_bits[3]
           ? {~(_page_sttlb_storage_fa_io_access_0_touch_ways_bits[2]),
              _page_sttlb_storage_fa_io_access_0_touch_ways_bits[2]
  ...
  wire [30:0] _refill_idx_state_reg_T_161 =
    _page_sttlb_storage_fa_io_access_0_touch_ways_bits[5]
      ...
      : {~(_page_sttlb_storage_fa_io_access_0_touch_ways_bits[4]),
         _page_sttlb_storage_fa_io_access_0_touch_ways_bits[4]
           ? {~(_page_sttlb_storage_fa_io_access_0_touch_ways_bits[3]),
              _page_sttlb_storage_fa_io_access_0_touch_ways_bits[3]
                ? {~(_page_sttlb_storage_fa_io_access_0_touch_ways_bits[2]),
    ...
    if (reset)
      ...
      if (_page_sttlb_storage_fa_io_access_1_touch_ways_valid)
        refill_idx_state_reg <=
          {~(_page_sttlb_storage_fa_io_access_1_touch_ways_bits[5]),
           _page_sttlb_storage_fa_io_access_1_touch_ways_bits[5]
             ? {~(_page_sttlb_storage_fa_io_access_1_touch_ways_bits[3]),
                _page_sttlb_storage_fa_io_access_1_touch_ways_bits[3]
                  ? {~(_page_sttlb_storage_fa_io_access_1_touch_ways_bits[2]),
                     _page_sttlb_storage_fa_io_access_1_touch_ways_bits[2]
           ...
           _page_sttlb_storage_fa_io_access_1_touch_ways_bits[5]
             ...
             : {~(_page_sttlb_storage_fa_io_access_1_touch_ways_bits[4]),
                _page_sttlb_storage_fa_io_access_1_touch_ways_bits[4]
                  ? {~(_page_sttlb_storage_fa_io_access_1_touch_ways_bits[3]),
                     _page_sttlb_storage_fa_io_access_1_touch_ways_bits[3]
                       ? {~(_page_sttlb_storage_fa_io_access_1_touch_ways_bits[2]),
