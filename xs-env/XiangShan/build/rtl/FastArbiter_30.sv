...
module FastArbiter_30(
  ...
  assign io_out_bits_tag =
    ...
    | (chosenOH[10] ? io_in_10_bits_tag : 34'h0)
    | (chosenOH[11] ? io_in_11_bits_tag : 34'h0)
    | (chosenOH[12] ? io_in_12_bits_tag : 34'h0)
    | (chosenOH[13] ? io_in_13_bits_tag : 34'h0);
endmodule
