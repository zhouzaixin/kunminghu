...
module FastArbiter_27(
  ...
  input         io_in_2_bits_data_prefetch,
  ...
  input         io_in_3_bits_data_prefetch,
  ...
  input         io_in_4_bits_data_prefetch,
  ...
  input         io_in_5_bits_data_prefetch,
  ...
  input         io_in_6_bits_data_prefetch,
  ...
  input         io_in_7_bits_data_prefetch,
  ...
  input         io_in_8_bits_data_prefetch,
  ...
  input         io_in_9_bits_data_prefetch,
  ...
  input         io_in_10_bits_data_prefetch,
  ...
  input         io_in_11_bits_data_prefetch,
  ...
  input         io_in_12_bits_data_prefetch,
  ...
  input         io_in_13_bits_data_prefetch,
  output        io_in_14_ready,
  input         io_in_14_valid,
  input  [10:0] io_in_14_bits_set,
  ...
  input         io_in_14_bits_data_prefetch,
  output        io_in_15_ready,
  input         io_in_15_valid,
  input  [10:0] io_in_15_bits_set,
  ...
  input         io_in_15_bits_data_prefetch,
  output        io_out_valid,
  ...
  assign io_out_bits_set =
    ...
    | (chosenOH[4] ? io_in_4_bits_set : 11'h0) | (chosenOH[5] ? io_in_5_bits_set : 11'h0)
    | (chosenOH[6] ? io_in_6_bits_set : 11'h0) | (chosenOH[7] ? io_in_7_bits_set : 11'h0)
    | (chosenOH[8] ? io_in_8_bits_set : 11'h0) | (chosenOH[9] ? io_in_9_bits_set : 11'h0)
    ...
    | (chosenOH[14] ? io_in_14_bits_set : 11'h0)
    | (chosenOH[15] ? io_in_15_bits_set : 11'h0);
  ...
  assign io_out_bits_data_dirty =
    chosenOH[0] & io_in_0_bits_data_dirty | chosenOH[1] & io_in_1_bits_data_dirty
    | chosenOH[2] & io_in_2_bits_data_dirty | chosenOH[3] & io_in_3_bits_data_dirty
    | chosenOH[4] & io_in_4_bits_data_dirty | chosenOH[5] & io_in_5_bits_data_dirty
    | chosenOH[6] & io_in_6_bits_data_dirty | chosenOH[7] & io_in_7_bits_data_dirty
    | chosenOH[8] & io_in_8_bits_data_dirty | chosenOH[9] & io_in_9_bits_data_dirty
    | chosenOH[10] & io_in_10_bits_data_dirty | chosenOH[11] & io_in_11_bits_data_dirty
    | chosenOH[12] & io_in_12_bits_data_dirty | chosenOH[13] & io_in_13_bits_data_dirty
    | chosenOH[14] & io_in_14_bits_data_dirty | chosenOH[15] & io_in_15_bits_data_dirty;
  assign io_out_bits_data_state =
    (chosenOH[0] ? io_in_0_bits_data_state : 2'h0)
    | (chosenOH[1] ? io_in_1_bits_data_state : 2'h0)
    | (chosenOH[2] ? io_in_2_bits_data_state : 2'h0)
    | (chosenOH[3] ? io_in_3_bits_data_state : 2'h0)
    | (chosenOH[4] ? io_in_4_bits_data_state : 2'h0)
    | (chosenOH[5] ? io_in_5_bits_data_state : 2'h0)
    | (chosenOH[6] ? io_in_6_bits_data_state : 2'h0)
    | (chosenOH[7] ? io_in_7_bits_data_state : 2'h0)
    | (chosenOH[8] ? io_in_8_bits_data_state : 2'h0)
    | (chosenOH[9] ? io_in_9_bits_data_state : 2'h0)
    | (chosenOH[10] ? io_in_10_bits_data_state : 2'h0)
    | (chosenOH[11] ? io_in_11_bits_data_state : 2'h0)
    | (chosenOH[12] ? io_in_12_bits_data_state : 2'h0)
    | (chosenOH[13] ? io_in_13_bits_data_state : 2'h0)
    | (chosenOH[14] ? io_in_14_bits_data_state : 2'h0)
    | (chosenOH[15] ? io_in_15_bits_data_state : 2'h0);
  assign io_out_bits_data_clientStates_0 =
    (chosenOH[0] ? io_in_0_bits_data_clientStates_0 : 2'h0)
    | (chosenOH[1] ? io_in_1_bits_data_clientStates_0 : 2'h0)
    | (chosenOH[2] ? io_in_2_bits_data_clientStates_0 : 2'h0)
    | (chosenOH[3] ? io_in_3_bits_data_clientStates_0 : 2'h0)
    | (chosenOH[4] ? io_in_4_bits_data_clientStates_0 : 2'h0)
    | (chosenOH[5] ? io_in_5_bits_data_clientStates_0 : 2'h0)
    | (chosenOH[6] ? io_in_6_bits_data_clientStates_0 : 2'h0)
    | (chosenOH[7] ? io_in_7_bits_data_clientStates_0 : 2'h0)
    | (chosenOH[8] ? io_in_8_bits_data_clientStates_0 : 2'h0)
    | (chosenOH[9] ? io_in_9_bits_data_clientStates_0 : 2'h0)
    ...
    | (chosenOH[15] ? io_in_15_bits_data_clientStates_0 : 2'h0);
  assign io_out_bits_data_prefetch =
    chosenOH[0] & io_in_0_bits_data_prefetch | chosenOH[1] & io_in_1_bits_data_prefetch
    | chosenOH[2] & io_in_2_bits_data_prefetch | chosenOH[3] & io_in_3_bits_data_prefetch
    | chosenOH[4] & io_in_4_bits_data_prefetch | chosenOH[5] & io_in_5_bits_data_prefetch
    | chosenOH[6] & io_in_6_bits_data_prefetch | chosenOH[7] & io_in_7_bits_data_prefetch
    | chosenOH[8] & io_in_8_bits_data_prefetch | chosenOH[9] & io_in_9_bits_data_prefetch
    | chosenOH[10] & io_in_10_bits_data_prefetch | chosenOH[11]
    & io_in_11_bits_data_prefetch | chosenOH[12] & io_in_12_bits_data_prefetch
    | chosenOH[13] & io_in_13_bits_data_prefetch | chosenOH[14]
    & io_in_14_bits_data_prefetch | chosenOH[15] & io_in_15_bits_data_prefetch;
endmodule
