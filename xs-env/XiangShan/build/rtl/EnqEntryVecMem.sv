...
module EnqEntryVecMem(
  ...
  output [5:0]   io_commonOut_transEntry_bits_status_vecMem_sqIdx_value,
  output         io_commonOut_transEntry_bits_status_vecMem_lqIdx_flag,
  output [6:0]   io_commonOut_transEntry_bits_status_vecMem_lqIdx_value,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_fuType_33 = _RANDOM[6'h1][11];
        entryReg_status_fuType_34 = _RANDOM[6'h1][12];
        ...
        enqDelayValidReg_last_REG = _RANDOM[6'h2C][2];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
