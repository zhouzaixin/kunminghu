...
module AXI4UserYanker_1(
  ...
  Queue1_BundleMap_74 Queue1_BundleMap (
    .clock                (clock),
    .reset                (reset),
  ...
  Queue1_BundleMap_74 Queue1_BundleMap_1 (
    .clock                (clock),
    .reset                (reset),
  ...
  Queue1_BundleMap_74 Queue1_BundleMap_2 (
    .clock                (clock),
    .reset                (reset),
  ...
  Queue1_BundleMap_74 Queue1_BundleMap_3 (
    .clock                (clock),
    .reset                (reset),
  ...
  Queue1_BundleMap_74 Queue1_BundleMap_4 (
    .clock                (clock),
    .reset                (reset),
  ...
  Queue1_BundleMap_74 Queue1_BundleMap_5 (
    .clock                (clock),
    .reset                (reset),
