...
module Queue1_PrefetchReq_1(
  ...
  always @(posedge clock) begin
    if (do_enq)
      ram <= {io_enq_bits_pfSource, 12'h0, io_enq_bits_set, io_enq_bits_tag};
  end // always @(posedge)
  ...
  assign io_deq_bits_tag = ram[30:0];
  assign io_deq_bits_set = ram[41:31];
  assign io_deq_bits_needT = ram[42];
  assign io_deq_bits_source = ram[53:43];
  assign io_deq_bits_pfSource = ram[57:54];
endmodule
