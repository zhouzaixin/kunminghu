...
module StdFreeList_2(
  ...
  input        io_commit_info_0_v0Wen,
  input        io_commit_info_1_v0Wen,
  input        io_commit_info_2_v0Wen,
  input        io_commit_info_3_v0Wen,
  input        io_commit_info_4_v0Wen,
  input        io_commit_info_5_v0Wen,
  ...
  wire [6:0]       _tailPtr_diff_T_4 = 7'({1'h0, tailPtr_new_value} - 7'h15);
  ...
  wire [7:0]       phyRegCandidates_0 =
    ...
    | (headPtrOH[20] ? freeList_20 : 8'h0);
  wire [7:0][7:0]  _GEN_7 =
    {{phyRegCandidates_0},
     {(headPtrOH[15] ? freeList_0 : 8'h0) | (headPtrOH[16] ? freeList_1 : 8'h0)
        | (headPtrOH[17] ? freeList_2 : 8'h0) | (headPtrOH[18] ? freeList_3 : 8'h0)
        | (headPtrOH[19] ? freeList_4 : 8'h0) | (headPtrOH[20] ? freeList_5 : 8'h0)
     ...
     {(headPtrOH[16] ? freeList_0 : 8'h0) | (headPtrOH[17] ? freeList_1 : 8'h0)
        ...
        | (headPtrOH[15] ? freeList_20 : 8'h0)},
     {(headPtrOH[17] ? freeList_0 : 8'h0) | (headPtrOH[18] ? freeList_1 : 8'h0)
        | (headPtrOH[19] ? freeList_2 : 8'h0) | (headPtrOH[20] ? freeList_3 : 8'h0)
        ...
        | (headPtrOH[16] ? freeList_20 : 8'h0)},
     {(headPtrOH[18] ? freeList_0 : 8'h0) | (headPtrOH[19] ? freeList_1 : 8'h0)
        | (headPtrOH[20] ? freeList_2 : 8'h0) | (headPtrOH[0] ? freeList_3 : 8'h0)
        ...
        | (headPtrOH[17] ? freeList_20 : 8'h0)},
     {(headPtrOH[19] ? freeList_0 : 8'h0) | (headPtrOH[20] ? freeList_1 : 8'h0)
        ...
        | (headPtrOH[18] ? freeList_20 : 8'h0)},
     {(headPtrOH[20] ? freeList_0 : 8'h0) | (headPtrOH[0] ? freeList_1 : 8'h0)
  ...
  wire [4:0]       _freeRegCnt_T_45 = 5'(_tailPtr_new_ptr_value_T_1 - 5'hB);
  wire [4:0]       freeRegCnt =
  ...
  always @(posedge clock) begin
    ...
    io_perf_0_value_REG <= freeRegCntReg < 5'h5;
    io_perf_0_value_REG_1 <= io_perf_0_value_REG;
    io_perf_1_value_REG <= freeRegCntReg > 5'h4 & freeRegCntReg < 5'hA;
    io_perf_1_value_REG_1 <= io_perf_1_value_REG;
    io_perf_2_value_REG <= freeRegCntReg > 5'h9 & freeRegCntReg < 5'hF;
    io_perf_2_value_REG_1 <= io_perf_2_value_REG;
    io_perf_3_value_REG <= freeRegCntReg > 5'hE;
  ...
  wire [6:0]       _redirectedHeadPtr_diff_T_4 =
    7'({1'h0, redirectedHeadPtr_new_value} - 7'h15);
  ...
  wire [6:0]       _redirectedHeadPtrOH_diff_T_4 =
    7'({1'h0, redirectedHeadPtrOH_new_value} - 7'h15);
  wire [3:0]       _GEN_16 =
  ...
  wire [6:0]       _enqPtr_diff_T_4 = 7'({2'h0, lastTailPtr_value} - 7'h15);
  ...
  wire [6:0]       _enqPtr_diff_T_10 = 7'({1'h0, enqPtr_new_value_1} - 7'h15);
  ...
  wire [6:0]       _enqPtr_diff_T_16 = 7'({1'h0, enqPtr_new_value_2} - 7'h15);
  ...
  wire [6:0]       _enqPtr_diff_T_22 = 7'({1'h0, enqPtr_new_value_3} - 7'h15);
  ...
  wire [6:0]       _enqPtr_diff_T_28 = 7'({1'h0, enqPtr_new_value_4} - 7'h15);
  ...
  wire [6:0]       _enqPtr_diff_T_34 = 7'({1'h0, enqPtr_new_value_5} - 7'h15);
  ...
  wire [5:0]       archHeadPtrNew_new_value =
    6'(_GEN_18
       + {3'h0,
          3'({1'h0,
              2'({1'h0, io_commit_commitValid_0 & io_commit_info_0_v0Wen}
                 + 2'({1'h0, io_commit_commitValid_1 & io_commit_info_1_v0Wen}
                      + {1'h0, io_commit_commitValid_2 & io_commit_info_2_v0Wen}))}
             + {1'h0,
                2'({1'h0, io_commit_commitValid_3 & io_commit_info_3_v0Wen}
                   + 2'({1'h0, io_commit_commitValid_4 & io_commit_info_4_v0Wen}
                        + {1'h0, io_commit_commitValid_5 & io_commit_info_5_v0Wen}))})});
  wire [6:0]       _archHeadPtrNew_diff_T_4 =
    7'({1'h0, archHeadPtrNew_new_value} - 7'h15);
  ...
  wire [6:0]       _redirectedHeadPtr_diff_T_10 =
    7'({1'h0, redirectedHeadPtr_new_value_1} - 7'h15);
  ...
  wire [6:0]       _redirectedHeadPtrOH_diff_T_10 =
    7'({1'h0, redirectedHeadPtrOH_new_value_1} - 7'h15);
    ...
    if (reset) begin
      ...
      if (~io_redirect & (isWalkAlloc | isNormalAlloc)) begin
        if (lastCycleRedirect) begin
          ...
          headPtrOH <=
            lastCycleSnpt_useSnpt
              ? _redirectedHeadPtrOH_T_10[20:0]
              : _redirectedHeadPtrOH_T_22[20:0];
        end
        else begin
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        headPtrOH = {_RANDOM[4'h0][31:26], _RANDOM[4'h1][14:0]};
        archHeadPtr_flag = _RANDOM[4'h1][15];
        archHeadPtr_value = _RANDOM[4'h1][20:16];
        freeList_0 = _RANDOM[4'h1][28:21];
        freeList_1 = {_RANDOM[4'h1][31:29], _RANDOM[4'h2][4:0]};
        freeList_2 = _RANDOM[4'h2][12:5];
        freeList_3 = _RANDOM[4'h2][20:13];
        freeList_4 = _RANDOM[4'h2][28:21];
        freeList_5 = {_RANDOM[4'h2][31:29], _RANDOM[4'h3][4:0]};
        freeList_6 = _RANDOM[4'h3][12:5];
        freeList_7 = _RANDOM[4'h3][20:13];
        freeList_8 = _RANDOM[4'h3][28:21];
        freeList_9 = {_RANDOM[4'h3][31:29], _RANDOM[4'h4][4:0]};
        freeList_10 = _RANDOM[4'h4][12:5];
        freeList_11 = _RANDOM[4'h4][20:13];
        freeList_12 = _RANDOM[4'h4][28:21];
        freeList_13 = {_RANDOM[4'h4][31:29], _RANDOM[4'h5][4:0]};
        freeList_14 = _RANDOM[4'h5][12:5];
        freeList_15 = _RANDOM[4'h5][20:13];
        freeList_16 = _RANDOM[4'h5][28:21];
        freeList_17 = {_RANDOM[4'h5][31:29], _RANDOM[4'h6][4:0]};
        freeList_18 = _RANDOM[4'h6][12:5];
        freeList_19 = _RANDOM[4'h6][20:13];
        freeList_20 = _RANDOM[4'h6][28:21];
        lastTailPtr_flag = _RANDOM[4'h6][29];
        lastTailPtr_value = {_RANDOM[4'h6][31:30], _RANDOM[4'h7][2:0]};
        io_canAllocate_last_REG = _RANDOM[4'h7][24];
        freeRegCntReg = _RANDOM[4'h7][29:25];
        io_perf_0_value_REG = _RANDOM[4'h7][30];
        io_perf_0_value_REG_1 = _RANDOM[4'h7][31];
        io_perf_1_value_REG = _RANDOM[4'h8][0];
        io_perf_1_value_REG_1 = _RANDOM[4'h8][1];
        io_perf_2_value_REG = _RANDOM[4'h8][2];
        io_perf_2_value_REG_1 = _RANDOM[4'h8][3];
        io_perf_3_value_REG = _RANDOM[4'h8][4];
        io_perf_3_value_REG_1 = _RANDOM[4'h8][5];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        lastCycleSnpt_REG_useSnpt = 1'h0;
        lastCycleSnpt_REG_snptSelect = 2'h0;
