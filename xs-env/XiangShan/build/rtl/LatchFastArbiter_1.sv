...
module LatchFastArbiter_1(
  ...
  reg         out_bits_reg_clients;
  reg         out_bits_reg_needData;
  reg  [13:0] chosen_reg;
  wire [13:0] valids =
    {io_in_13_valid,
     io_in_12_valid,
    ...
    if (reset) begin
      ...
      if (latch_result) begin
        ...
        out_bits_reg_clients <=
          chosenOH[0] & io_in_0_bits_clients | chosenOH[1] & io_in_1_bits_clients
          | chosenOH[2] & io_in_2_bits_clients | chosenOH[3] & io_in_3_bits_clients
          | chosenOH[4] & io_in_4_bits_clients | chosenOH[5] & io_in_5_bits_clients
          | chosenOH[6] & io_in_6_bits_clients | chosenOH[7] & io_in_7_bits_clients
          | chosenOH[8] & io_in_8_bits_clients | chosenOH[9] & io_in_9_bits_clients
          | chosenOH[10] & io_in_10_bits_clients | chosenOH[11] & io_in_11_bits_clients
          | chosenOH[12] & io_in_12_bits_clients | chosenOH[13] & io_in_13_bits_clients;
        out_bits_reg_needData <=
          chosenOH[0] & io_in_0_bits_needData | chosenOH[1] & io_in_1_bits_needData
          | chosenOH[2] & io_in_2_bits_needData | chosenOH[3] & io_in_3_bits_needData
          | chosenOH[4] & io_in_4_bits_needData | chosenOH[5] & io_in_5_bits_needData
          | chosenOH[6] & io_in_6_bits_needData | chosenOH[7] & io_in_7_bits_needData
          | chosenOH[8] & io_in_8_bits_needData | chosenOH[9] & io_in_9_bits_needData
          | chosenOH[10] & io_in_10_bits_needData | chosenOH[11] & io_in_11_bits_needData
          | chosenOH[12] & io_in_12_bits_needData | chosenOH[13] & io_in_13_bits_needData;
        chosen_reg <= chosenOH;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_set = _RANDOM[2'h0][11:1];
        out_bits_reg_tag = {_RANDOM[2'h0][31:12], _RANDOM[2'h1][10:0]};
        out_bits_reg_param = _RANDOM[2'h1][13:11];
        out_bits_reg_clients = _RANDOM[2'h1][14];
        out_bits_reg_needData = _RANDOM[2'h1][15];
        chosen_reg = _RANDOM[2'h1][29:16];
        pendingMask = {_RANDOM[2'h1][31:30], _RANDOM[2'h2][11:0]};
        rrGrantMask = _RANDOM[2'h2][25:12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_set = 11'h0;
  ...
  assign io_out_bits_clients = out_bits_reg_clients;
  assign io_out_bits_needData = out_bits_reg_needData;
endmodule
