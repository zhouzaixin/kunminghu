  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_robIdx_value = _RANDOM[4'h7][21:14];
        data_pdest = {_RANDOM[4'h7][31:27], _RANDOM[4'h8][2:0]};
        data_rfWen = _RANDOM[4'h8][3];
        data_flushPipe = _RANDOM[4'h8][4];
        data_ftqIdx_flag = _RANDOM[4'h8][11];
        data_ftqIdx_value = _RANDOM[4'h8][17:12];
        data_ftqOffset = _RANDOM[4'h8][21:18];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
