...
module SnapshotGenerator_1(
  ...
  reg  [5:0] snapshots_0_value;
  reg        snapshots_1_flag;
  reg  [5:0] snapshots_1_value;
  reg        snapshots_2_flag;
  reg  [5:0] snapshots_2_value;
  reg        snapshots_3_flag;
  reg  [5:0] snapshots_3_value;
  reg        snptEnqPtr_flag;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        snapshots_0_value = _RANDOM[1'h0][6:1];
        snapshots_1_flag = _RANDOM[1'h0][7];
        snapshots_1_value = _RANDOM[1'h0][13:8];
        snapshots_2_flag = _RANDOM[1'h0][14];
        snapshots_2_value = _RANDOM[1'h0][20:15];
        snapshots_3_flag = _RANDOM[1'h0][21];
        snapshots_3_value = _RANDOM[1'h0][27:22];
        snptEnqPtr_flag = _RANDOM[1'h0][28];
        snptEnqPtr_value = _RANDOM[1'h0][30:29];
        snptDeqPtr_flag = _RANDOM[1'h0][31];
        snptDeqPtr_value = _RANDOM[1'h1][1:0];
        snptValids_0 = _RANDOM[1'h1][2];
        snptValids_1 = _RANDOM[1'h1][3];
        snptValids_2 = _RANDOM[1'h1][4];
        snptValids_3 = _RANDOM[1'h1][5];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        snptEnqPtr_flag = 1'h0;
        snptEnqPtr_value = 2'h0;
