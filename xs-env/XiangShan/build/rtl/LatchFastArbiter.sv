...
module LatchFastArbiter(
    ...
    if (reset) begin
      ...
      if (latch_result) begin
        ...
        out_bits_reg_putData <=
          chosenOH[0] & io_in_0_bits_putData | chosenOH[1] & io_in_1_bits_putData
          | chosenOH[2] & io_in_2_bits_putData | chosenOH[3] & io_in_3_bits_putData
          | chosenOH[4] & io_in_4_bits_putData | chosenOH[5] & io_in_5_bits_putData
          | chosenOH[6] & io_in_6_bits_putData | chosenOH[7] & io_in_7_bits_putData
          | chosenOH[8] & io_in_8_bits_putData | chosenOH[9] & io_in_9_bits_putData
          | chosenOH[10] & io_in_10_bits_putData | chosenOH[11] & io_in_11_bits_putData
          | chosenOH[12] & io_in_12_bits_putData | chosenOH[13] & io_in_13_bits_putData;
        chosen_reg <= chosenOH;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_tag = _RANDOM[3'h0][31:1];
        out_bits_reg_set = _RANDOM[3'h1][10:0];
        out_bits_reg_off = _RANDOM[3'h1][16:11];
        out_bits_reg_opcode = _RANDOM[3'h2][19:17];
        out_bits_reg_param = _RANDOM[3'h2][22:20];
        out_bits_reg_source = _RANDOM[3'h2][26:23];
        out_bits_reg_bufIdx = _RANDOM[3'h2][30:27];
        out_bits_reg_size = {_RANDOM[3'h2][31], _RANDOM[3'h3][1:0]};
        out_bits_reg_putData = _RANDOM[3'h3][3];
        chosen_reg = _RANDOM[3'h3][21:8];
        pendingMask = {_RANDOM[3'h3][31:22], _RANDOM[3'h4][3:0]};
        rrGrantMask = _RANDOM[3'h4][17:4];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_tag = 31'h0;
  ...
  assign io_out_bits_putData = out_bits_reg_putData;
endmodule
