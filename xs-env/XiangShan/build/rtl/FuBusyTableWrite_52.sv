...
module FuBusyTableWrite_52(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset)
      ...
      fuBusyTable <=
        {1'h0,
         ~(io_in_og0Resp_valid ? {1'h0, io_in_og0Resp_bits_fuType[12], 1'h0} : 3'h0)
           & fuBusyTable[3:1]}
        | (io_in_deqResp_valid
             ? {1'h0, io_in_deqResp_bits_fuType[12], 1'h0, io_in_deqResp_bits_fuType[11]}
             : 4'h0);
