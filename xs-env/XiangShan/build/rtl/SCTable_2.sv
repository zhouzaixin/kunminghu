...
module SCTable_2(
  ...
  wire [7:0]  s0_idx = io_req_bits_pc[8:1] ^ io_req_bits_folded_hist_hist_11_folded_hist;
  reg  [7:0]  s1_idx;
  reg  [49:0] s1_pc;
  ...
  wire        write_conflict = update_idx == s0_idx & _write_conflict_T_1 & io_req_valid;
  wire        can_write =
    (conflict_buffer_idx != s0_idx | ~io_req_valid) & conflict_buffer_valid;
  ...
  SRAMTemplate_56 table_0 (
    ...
    .io_w_req_bits_setIdx  (can_write ? conflict_buffer_idx : update_idx),
