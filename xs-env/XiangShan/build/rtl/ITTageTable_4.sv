...
module ITTageTable_4(
  ...
  wire [8:0] _update_folded_hist_hist_10_folded_hist_T_5 =
    io_update_ghist[8:0] ^ io_update_ghist[17:9]
    ^ {io_update_ghist[26:23], io_update_ghist[22:18] ^ io_update_ghist[31:27]};
  wire [8:0] update_idx = io_update_pc[9:1] ^ _update_folded_hist_hist_10_folded_hist_T_5;
  reg        needReset;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_read_write_conflict = _RANDOM[/*Zero width*/ 1'b0][19];
        needReset = _RANDOM[/*Zero width*/ 1'b0][20];
        resetSet = _RANDOM[/*Zero width*/ 1'b0][29:21];
        powerOnResetState = _RANDOM[/*Zero width*/ 1'b0][30];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        needReset = 1'h0;
        resetSet = 9'h0;
  ...
  FoldedSRAMTemplate_23 table_0 (
    ...
    .io_r_req_bits_setIdx
      (io_req_bits_pc[9:1] ^ io_req_bits_folded_hist_hist_10_folded_hist),
    ...
    .io_w_req_bits_data_0_tag
      (io_update_pc[18:10] ^ _update_folded_hist_hist_10_folded_hist_T_5
       ^ {io_update_ghist[7:0] ^ io_update_ghist[15:8] ^ io_update_ghist[23:16]
            ^ io_update_ghist[31:24],
          1'h0}),
