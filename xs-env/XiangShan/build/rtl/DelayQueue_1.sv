  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        queue_0_cnt = _RANDOM[5'h1][19:12];
        queue_1_addrNoOffset = {_RANDOM[5'h1][31:20], _RANDOM[5'h2]};
        queue_1_cnt = _RANDOM[5'h3][7:0];
        queue_2_addrNoOffset = {_RANDOM[5'h3][31:8], _RANDOM[5'h4][19:0]};
        queue_2_cnt = _RANDOM[5'h4][27:20];
        queue_3_addrNoOffset = {_RANDOM[5'h4][31:28], _RANDOM[5'h5], _RANDOM[5'h6][7:0]};
        queue_3_cnt = _RANDOM[5'h6][15:8];
        queue_4_addrNoOffset = {_RANDOM[5'h6][31:16], _RANDOM[5'h7][27:0]};
        queue_4_cnt = {_RANDOM[5'h7][31:28], _RANDOM[5'h8][3:0]};
        queue_5_addrNoOffset = {_RANDOM[5'h8][31:4], _RANDOM[5'h9][15:0]};
        queue_5_cnt = _RANDOM[5'h9][23:16];
        queue_6_addrNoOffset = {_RANDOM[5'h9][31:24], _RANDOM[5'hA], _RANDOM[5'hB][3:0]};
        queue_6_cnt = _RANDOM[5'hB][11:4];
        queue_7_addrNoOffset = {_RANDOM[5'hB][31:12], _RANDOM[5'hC][23:0]};
        queue_7_cnt = _RANDOM[5'hC][31:24];
        queue_8_addrNoOffset = {_RANDOM[5'hD], _RANDOM[5'hE][11:0]};
        queue_8_cnt = _RANDOM[5'hE][19:12];
        queue_9_addrNoOffset = {_RANDOM[5'hE][31:20], _RANDOM[5'hF]};
        queue_9_cnt = _RANDOM[5'h10][7:0];
        queue_10_addrNoOffset = {_RANDOM[5'h10][31:8], _RANDOM[5'h11][19:0]};
        queue_10_cnt = _RANDOM[5'h11][27:20];
        queue_11_addrNoOffset =
          {_RANDOM[5'h11][31:28], _RANDOM[5'h12], _RANDOM[5'h13][7:0]};
        queue_11_cnt = _RANDOM[5'h13][15:8];
        queue_12_addrNoOffset = {_RANDOM[5'h13][31:16], _RANDOM[5'h14][27:0]};
        queue_12_cnt = {_RANDOM[5'h14][31:28], _RANDOM[5'h15][3:0]};
        queue_13_addrNoOffset = {_RANDOM[5'h15][31:4], _RANDOM[5'h16][15:0]};
        queue_13_cnt = _RANDOM[5'h16][23:16];
        queue_14_addrNoOffset =
          {_RANDOM[5'h16][31:24], _RANDOM[5'h17], _RANDOM[5'h18][3:0]};
        queue_14_cnt = _RANDOM[5'h18][11:4];
        queue_15_addrNoOffset = {_RANDOM[5'h18][31:12], _RANDOM[5'h19][23:0]};
        queue_15_cnt = _RANDOM[5'h19][31:24];
