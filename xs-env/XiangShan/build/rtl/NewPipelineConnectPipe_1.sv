  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_pc = {_RANDOM[4'h8][31:9], _RANDOM[4'h9][26:0]};
        data_ftqIdx_flag = _RANDOM[4'hA][1];
        data_ftqIdx_value = _RANDOM[4'hA][7:2];
        data_ftqOffset = _RANDOM[4'hA][11:8];
        data_predictInfo_target = {_RANDOM[4'hA][31:12], _RANDOM[4'hB][29:0]};
        data_predictInfo_taken = _RANDOM[4'hB][30];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
