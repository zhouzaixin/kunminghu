  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_robIdx_value = _RANDOM[6'h9][22:15];
        bits_1_pdest = {_RANDOM[6'h9][31:28], _RANDOM[6'hA][3:0]};
        bits_1_fpWen = _RANDOM[6'hA][5];
        bits_1_vecWen = _RANDOM[6'hA][6];
        bits_1_v0Wen = _RANDOM[6'hA][7];
        bits_2_fuType = {_RANDOM[6'h1D][31:14], _RANDOM[6'h1E][16:0]};
        bits_2_robIdx_flag = _RANDOM[6'h26][26];
        bits_2_robIdx_value = {_RANDOM[6'h26][31:27], _RANDOM[6'h27][2:0]};
        bits_2_pdest = _RANDOM[6'h27][15:8];
        bits_2_fpWen = _RANDOM[6'h27][17];
        bits_2_vecWen = _RANDOM[6'h27][18];
        bits_2_v0Wen = _RANDOM[6'h27][19];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
