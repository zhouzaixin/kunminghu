...
module Queue2_TLBundleD_24(
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[24:15];
  assign io_deq_bits_denied = _ram_ext_R0_data[25];
  assign io_deq_bits_echo_isKeyword = _ram_ext_R0_data[26];
  assign io_deq_bits_data = _ram_ext_R0_data[282:27];
  assign io_deq_bits_corrupt = _ram_ext_R0_data[283];
endmodule
