...
module Queue2_TLBundleA_33(
  ...
  output [3:0]   io_deq_bits_user_reqSource,
  ...
  assign io_deq_bits_user_reqSource = _ram_ext_R0_data[68:65];
  assign io_deq_bits_user_alias = _ram_ext_R0_data[70:69];
  assign io_deq_bits_user_vaddr = _ram_ext_R0_data[114:71];
  assign io_deq_bits_user_needHint = _ram_ext_R0_data[115];
  assign io_deq_bits_echo_isKeyword = _ram_ext_R0_data[116];
  assign io_deq_bits_mask = _ram_ext_R0_data[148:117];
  assign io_deq_bits_data = _ram_ext_R0_data[404:149];
  assign io_deq_bits_corrupt = _ram_ext_R0_data[405];
endmodule
