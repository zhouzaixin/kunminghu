...
module OthersEntry_200(
  ...
  output [7:0]  io_commonOut_entry_bits_payload_waitForRobIdx_value,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_fuType_15 = _RANDOM[6'h0][25];
        ...
        entryReg_imm = {_RANDOM[6'h2][31:19], _RANDOM[6'h3][18:0]};
        entryReg_payload_preDecodeInfo_isRVC = _RANDOM[6'h7][14];
        entryReg_payload_ftqPtr_flag = _RANDOM[6'h7][21];
        entryReg_payload_ftqPtr_value = _RANDOM[6'h7][27:22];
        entryReg_payload_ftqOffset = _RANDOM[6'h7][31:28];
        entryReg_payload_fuOpType = {_RANDOM[6'h9][31:29], _RANDOM[6'hA][5:0]};
        entryReg_payload_rfWen = _RANDOM[6'hA][6];
        entryReg_payload_fpWen = _RANDOM[6'hA][7];
        entryReg_payload_pdest = _RANDOM[6'h15][18:11];
        entryReg_payload_storeSetHit = _RANDOM[6'h28][25];
        entryReg_payload_waitForRobIdx_flag = _RANDOM[6'h28][26];
        entryReg_payload_waitForRobIdx_value =
          {_RANDOM[6'h28][31:27], _RANDOM[6'h29][2:0]};
        entryReg_payload_loadWaitBit = _RANDOM[6'h29][3];
        entryReg_payload_loadWaitStrict = _RANDOM[6'h29][4];
        entryReg_payload_lqIdx_flag = _RANDOM[6'h29][10];
        entryReg_payload_lqIdx_value = _RANDOM[6'h29][17:11];
        entryReg_payload_sqIdx_flag = _RANDOM[6'h29][18];
        entryReg_payload_sqIdx_value = _RANDOM[6'h29][24:19];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validReg_last_REG = 1'h0;
    end // initial
