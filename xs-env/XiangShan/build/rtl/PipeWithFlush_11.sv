  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_2_robIdx_flag = _RANDOM[7'h26][25];
        bits_2_robIdx_value = {_RANDOM[7'h26][31:26], _RANDOM[7'h27][1:0]};
        bits_2_pdest = _RANDOM[7'h27][14:7];
        bits_2_fpWen = _RANDOM[7'h27][16];
        bits_3_robIdx_flag = _RANDOM[7'h44][3];
        bits_3_robIdx_value = _RANDOM[7'h44][11:4];
        bits_3_pdest = _RANDOM[7'h44][24:17];
        bits_3_fpWen = _RANDOM[7'h44][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
