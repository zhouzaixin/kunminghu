...
module MSHRBuffer(
  ...
  wire               _wens_T_5 = io_w_0_valid & io_w_0_bits_id == 8'h1;
  wire               _wens_T_9 = io_w_0_valid & io_w_0_bits_id == 8'h2;
  wire               _wens_T_13 = io_w_0_valid & io_w_0_bits_id == 8'h3;
  wire               _wens_T_17 = io_w_0_valid & io_w_0_bits_id == 8'h4;
  wire               _wens_T_21 = io_w_0_valid & io_w_0_bits_id == 8'h5;
  wire               _wens_T_25 = io_w_0_valid & io_w_0_bits_id == 8'h6;
  wire               _wens_T_29 = io_w_0_valid & io_w_0_bits_id == 8'h7;
  wire               _wens_T_33 = io_w_0_valid & io_w_0_bits_id == 8'h8;
  wire               _wens_T_37 = io_w_0_valid & io_w_0_bits_id == 8'h9;
  wire               _wens_T_41 = io_w_0_valid & io_w_0_bits_id == 8'hA;
  wire               _wens_T_45 = io_w_0_valid & io_w_0_bits_id == 8'hB;
  wire               _wens_T_49 = io_w_0_valid & io_w_0_bits_id == 8'hC;
  wire               _wens_T_53 = io_w_0_valid & io_w_0_bits_id == 8'hD;
  wire               _wens_T_57 = io_w_0_valid & io_w_0_bits_id == 8'hE;
  wire               _wens_T_61 = io_w_0_valid & io_w_0_bits_id == 8'hF;
  wire [511:0]       w_data_data =
    _wens_T_1 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_1_data =
    _wens_T_5 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_2_data =
    _wens_T_9 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_3_data =
    _wens_T_13 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_4_data =
    _wens_T_17 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_5_data =
    _wens_T_21 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_6_data =
    _wens_T_25 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_7_data =
    _wens_T_29 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_8_data =
    _wens_T_33 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_9_data =
    _wens_T_37 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_10_data =
    _wens_T_41 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_11_data =
    _wens_T_45 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_12_data =
    _wens_T_49 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_13_data =
    _wens_T_53 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_14_data =
    _wens_T_57 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  wire [511:0]       w_data_15_data =
    _wens_T_61 ? io_w_0_bits_data_data : io_w_1_bits_data_data;
  always @(posedge clock) begin
    if (|{io_w_1_valid & io_w_1_bits_id == 8'h0, _wens_T_1}) begin
      buffer_0_0 <= w_data_data[255:0];
      buffer_0_1 <= w_data_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'h1, _wens_T_5}) begin
      buffer_1_0 <= w_data_1_data[255:0];
      buffer_1_1 <= w_data_1_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'h2, _wens_T_9}) begin
      buffer_2_0 <= w_data_2_data[255:0];
      buffer_2_1 <= w_data_2_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'h3, _wens_T_13}) begin
      buffer_3_0 <= w_data_3_data[255:0];
      buffer_3_1 <= w_data_3_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'h4, _wens_T_17}) begin
      buffer_4_0 <= w_data_4_data[255:0];
      buffer_4_1 <= w_data_4_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'h5, _wens_T_21}) begin
      buffer_5_0 <= w_data_5_data[255:0];
      buffer_5_1 <= w_data_5_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'h6, _wens_T_25}) begin
      buffer_6_0 <= w_data_6_data[255:0];
      buffer_6_1 <= w_data_6_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'h7, _wens_T_29}) begin
      buffer_7_0 <= w_data_7_data[255:0];
      buffer_7_1 <= w_data_7_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'h8, _wens_T_33}) begin
      buffer_8_0 <= w_data_8_data[255:0];
      buffer_8_1 <= w_data_8_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'h9, _wens_T_37}) begin
      buffer_9_0 <= w_data_9_data[255:0];
      buffer_9_1 <= w_data_9_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'hA, _wens_T_41}) begin
      buffer_10_0 <= w_data_10_data[255:0];
      buffer_10_1 <= w_data_10_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'hB, _wens_T_45}) begin
      buffer_11_0 <= w_data_11_data[255:0];
      buffer_11_1 <= w_data_11_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'hC, _wens_T_49}) begin
      buffer_12_0 <= w_data_12_data[255:0];
      buffer_12_1 <= w_data_12_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'hD, _wens_T_53}) begin
      buffer_13_0 <= w_data_13_data[255:0];
      buffer_13_1 <= w_data_13_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'hE, _wens_T_57}) begin
      buffer_14_0 <= w_data_14_data[255:0];
      buffer_14_1 <= w_data_14_data[511:256];
    end
    if (|{io_w_1_valid & io_w_1_bits_id == 8'hF, _wens_T_61}) begin
