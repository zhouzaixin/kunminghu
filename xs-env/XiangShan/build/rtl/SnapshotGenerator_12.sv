...
module SnapshotGenerator_12(
  input        clock,
  input        reset,
  input        io_enq,
  input        io_enqData_flag,
  input  [4:0] io_enqData_value,
  input        io_deq,
  input        io_redirect,
  input        io_flushVec_0,
  input        io_flushVec_1,
  ...
  reg  [4:0] snapshots_0_value;
  reg        snapshots_1_flag;
  reg  [4:0] snapshots_1_value;
  reg        snapshots_2_flag;
  reg  [4:0] snapshots_2_value;
  reg        snapshots_3_flag;
  reg  [4:0] snapshots_3_value;
  reg        snptEnqPtr_flag;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        snapshots_0_value = _RANDOM[1'h0][5:1];
        snapshots_1_flag = _RANDOM[1'h0][6];
        snapshots_1_value = _RANDOM[1'h0][11:7];
        snapshots_2_flag = _RANDOM[1'h0][12];
        snapshots_2_value = _RANDOM[1'h0][17:13];
        snapshots_3_flag = _RANDOM[1'h0][18];
        snapshots_3_value = _RANDOM[1'h0][23:19];
        snptEnqPtr_flag = _RANDOM[1'h0][24];
        snptEnqPtr_value = _RANDOM[1'h0][26:25];
        snptDeqPtr_flag = _RANDOM[1'h0][27];
        snptDeqPtr_value = _RANDOM[1'h0][29:28];
        snptValids_0 = _RANDOM[1'h0][30];
        snptValids_1 = _RANDOM[1'h0][31];
        snptValids_2 = _RANDOM[1'h1][0];
        snptValids_3 = _RANDOM[1'h1][1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        snptEnqPtr_flag = 1'h0;
        snptEnqPtr_value = 2'h0;
