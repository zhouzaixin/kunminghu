...
module VScauseModule(
  ...
  always @(posedge clock or posedge reset) begin
    ...
    else if (w_wen | trapToVS_vscause_valid) begin
      reg_Interrupt <=
        trapToVS_vscause_valid & trapToVS_vscause_bits_Interrupt | w_wen & w_wdata[63];
      reg_ExceptionCode <=
        (trapToVS_vscause_valid ? trapToVS_vscause_bits_ExceptionCode : 63'h0)
