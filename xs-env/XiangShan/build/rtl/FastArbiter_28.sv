...
module FastArbiter_28(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        pendingMask = _RANDOM[/*Zero width*/ 1'b0][13:0];
        rrGrantMask = _RANDOM[/*Zero width*/ 1'b0][27:14];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        pendingMask = 14'h0;
        rrGrantMask = 14'h0;
  ...
  assign io_out_bits_tag =
    ...
    | (chosenOH[4] ? io_in_4_bits_tag : 31'h0) | (chosenOH[5] ? io_in_5_bits_tag : 31'h0)
    | (chosenOH[6] ? io_in_6_bits_tag : 31'h0) | (chosenOH[7] ? io_in_7_bits_tag : 31'h0)
    | (chosenOH[8] ? io_in_8_bits_tag : 31'h0) | (chosenOH[9] ? io_in_9_bits_tag : 31'h0)
