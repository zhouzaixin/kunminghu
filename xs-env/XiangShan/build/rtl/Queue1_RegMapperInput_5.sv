...
module Queue1_RegMapperInput_5(
  input         clock,
  input         reset,
  output        io_enq_ready,
  input         io_enq_valid,
  ...
  assign io_deq_bits_data = ram[77:14];
  assign io_deq_bits_mask = ram[85:78];
  assign io_deq_bits_extra_tlrr_extra_source = ram[88:86];
  assign io_deq_bits_extra_tlrr_extra_size = ram[90:89];
endmodule
