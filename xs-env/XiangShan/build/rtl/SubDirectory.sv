...
module SubDirectory(
  ...
  input  [33:0] io_tag_w_bits_tag,
  input  [7:0]  io_tag_w_bits_set,
  input  [3:0]  io_tag_w_bits_way,
  input         io_dir_w_valid,
  input  [7:0]  io_dir_w_bits_set,
  ...
  wire [33:0]       _tagArray_io_r_resp_data_0;
  wire [33:0]       _tagArray_io_r_resp_data_1;
  wire [33:0]       _tagArray_io_r_resp_data_2;
  wire [33:0]       _tagArray_io_r_resp_data_3;
  wire [33:0]       _tagArray_io_r_resp_data_4;
  wire [33:0]       _tagArray_io_r_resp_data_5;
  wire [33:0]       _tagArray_io_r_resp_data_6;
  wire [33:0]       _tagArray_io_r_resp_data_7;
  wire [33:0]       _tagArray_io_r_resp_data_8;
  wire [33:0]       _tagArray_io_r_resp_data_9;
  ...
  wire [33:0]       _syndromeUInt_T = io_tag_w_bits_tag & 34'h156AAAD5B;
  wire [33:0]       _syndromeUInt_T_3 = io_tag_w_bits_tag & 34'h19B33366D;
  wire [33:0]       _syndromeUInt_T_6 = io_tag_w_bits_tag & 34'h1E3C3C78E;
  wire [33:0]       _syndromeUInt_T_9 = io_tag_w_bits_tag & 34'h203FC07F0;
  wire [33:0]       _syndromeUInt_T_12 = io_tag_w_bits_tag & 34'h3FFF800;
  wire [33:0]       _syndromeUInt_T_15 = io_tag_w_bits_tag & 34'h3FC000000;
  wire [6:0]        _GEN =
    {^{^_syndromeUInt_T_15,
       ^_syndromeUInt_T_12,
       ^_syndromeUInt_T_9,
  ...
  reg  [33:0]       tagAll_s2_0;
  reg  [33:0]       tagAll_s2_1;
  reg  [33:0]       tagAll_s2_2;
  reg  [33:0]       tagAll_s2_3;
  reg  [33:0]       tagAll_s2_4;
  reg  [33:0]       tagAll_s2_5;
  reg  [33:0]       tagAll_s2_6;
  reg  [33:0]       tagAll_s2_7;
  reg  [33:0]       tagAll_s2_8;
  reg  [33:0]       tagAll_s2_9;
  reg               errorAll_s2_0;
  reg               errorAll_s2_1;
  reg               errorAll_s2_2;
  reg               errorAll_s2_3;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        resetIdx = _RANDOM[4'h0][8:1];
        reqReg_tag = {_RANDOM[4'h0][31:10], _RANDOM[4'h1][11:0]};
        reqValidReg = _RANDOM[4'h2][3];
        hit_s2 = _RANDOM[4'h2][4];
        way_s2 = _RANDOM[4'h2][8:5];
        metaAll_s2_0_0_state = _RANDOM[4'h2][10:9];
        metaAll_s2_1_0_state = _RANDOM[4'h2][12:11];
        metaAll_s2_2_0_state = _RANDOM[4'h2][14:13];
        metaAll_s2_3_0_state = _RANDOM[4'h2][16:15];
        metaAll_s2_4_0_state = _RANDOM[4'h2][18:17];
        metaAll_s2_5_0_state = _RANDOM[4'h2][20:19];
        metaAll_s2_6_0_state = _RANDOM[4'h2][22:21];
        metaAll_s2_7_0_state = _RANDOM[4'h2][24:23];
        metaAll_s2_8_0_state = _RANDOM[4'h2][26:25];
        metaAll_s2_9_0_state = _RANDOM[4'h2][28:27];
        tagAll_s2_0 = {_RANDOM[4'h2][31:29], _RANDOM[4'h3][30:0]};
        tagAll_s2_1 = {_RANDOM[4'h3][31], _RANDOM[4'h4], _RANDOM[4'h5][0]};
        tagAll_s2_2 = {_RANDOM[4'h5][31:1], _RANDOM[4'h6][2:0]};
        tagAll_s2_3 = {_RANDOM[4'h6][31:3], _RANDOM[4'h7][4:0]};
        tagAll_s2_4 = {_RANDOM[4'h7][31:5], _RANDOM[4'h8][6:0]};
        tagAll_s2_5 = {_RANDOM[4'h8][31:7], _RANDOM[4'h9][8:0]};
        tagAll_s2_6 = {_RANDOM[4'h9][31:9], _RANDOM[4'hA][10:0]};
        tagAll_s2_7 = {_RANDOM[4'hA][31:11], _RANDOM[4'hB][12:0]};
        tagAll_s2_8 = {_RANDOM[4'hB][31:13], _RANDOM[4'hC][14:0]};
        tagAll_s2_9 = {_RANDOM[4'hC][31:15], _RANDOM[4'hD][16:0]};
        errorAll_s2_0 = _RANDOM[4'hD][17];
        errorAll_s2_1 = _RANDOM[4'hD][18];
        errorAll_s2_2 = _RANDOM[4'hD][19];
        errorAll_s2_3 = _RANDOM[4'hD][20];
        errorAll_s2_4 = _RANDOM[4'hD][21];
        errorAll_s2_5 = _RANDOM[4'hD][22];
        errorAll_s2_6 = _RANDOM[4'hD][23];
        errorAll_s2_7 = _RANDOM[4'hD][24];
        errorAll_s2_8 = _RANDOM[4'hD][25];
        errorAll_s2_9 = _RANDOM[4'hD][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        resetFinish = 1'h0;
        resetIdx = 8'hFF;
