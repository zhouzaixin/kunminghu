...
module McauseModule(
  ...
  always @(posedge clock or posedge reset) begin
    ...
    else if (w_wen | trapToM_mcause_valid) begin
      reg_Interrupt <=
        trapToM_mcause_valid & trapToM_mcause_bits_Interrupt | w_wen & w_wdata[63];
      reg_ExceptionCode <=
        (trapToM_mcause_valid ? trapToM_mcause_bits_ExceptionCode : 63'h0)
