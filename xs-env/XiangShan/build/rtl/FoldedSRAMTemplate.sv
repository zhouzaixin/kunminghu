  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        holdRidx_last_REG = _RANDOM[/*Zero width*/ 1'b0][11];
        holdRidx_hold_data = _RANDOM[/*Zero width*/ 1'b0][14:12];
        holdRidx_last_REG_1 = _RANDOM[/*Zero width*/ 1'b0][15];
        holdRidx_hold_data_1 = _RANDOM[/*Zero width*/ 1'b0][18:16];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        holdRidx_last_REG = 1'h0;
        holdRidx_last_REG_1 = 1'h0;
