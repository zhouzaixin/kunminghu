...
module ExeUnit_13(
  ...
  wire [7:0]   _Vppu_io_out_bits_ctrl_robIdx_value;
  ...
  wire [7:0]   _Vimac_io_out_bits_ctrl_robIdx_value;
  ...
  wire [7:0]   _GEN = {1'h0, inPipe_1_2_pdest};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_1_robIdx_value = _RANDOM[8'h18][8:1];
        inPipe_1_1_pdest = _RANDOM[8'h18][20:14];
        inPipe_1_1_vecWen = _RANDOM[8'h18][21];
        inPipe_1_1_v0Wen = _RANDOM[8'h18][22];
        inPipe_1_1_fpu_wflags = _RANDOM[8'h18][25];
        inPipe_1_1_vpu_vma = _RANDOM[8'h19][2];
        inPipe_1_1_vpu_vta = _RANDOM[8'h19][3];
        inPipe_1_1_vpu_vsew = _RANDOM[8'h19][5:4];
        inPipe_1_1_vpu_vlmul = _RANDOM[8'h19][8:6];
        inPipe_1_1_vpu_vm = _RANDOM[8'h19][17];
        inPipe_1_1_vpu_vstart = _RANDOM[8'h19][25:18];
        inPipe_1_1_vpu_vuopIdx = _RANDOM[8'h1A][12:6];
        inPipe_1_1_vpu_isExt = _RANDOM[8'h1E][28];
        inPipe_1_1_vpu_isNarrow = _RANDOM[8'h1E][29];
        inPipe_1_1_vpu_isDstMask = _RANDOM[8'h1E][30];
        inPipe_1_1_vpu_isOpMask = _RANDOM[8'h1E][31];
        inPipe_1_2_fuOpType = {_RANDOM[8'h32][31:28], _RANDOM[8'h33][4:0]};
        inPipe_1_2_src_2 =
          {_RANDOM[8'h3B][31:5],
           _RANDOM[8'h3C],
           _RANDOM[8'h3D],
        ...
        inPipe_1_2_src_4 =
          {_RANDOM[8'h43][31:5],
           ...
           _RANDOM[8'h46],
           _RANDOM[8'h47][4:0]};
        inPipe_1_2_robIdx_flag = _RANDOM[8'h49][5];
        inPipe_1_2_robIdx_value = _RANDOM[8'h49][13:6];
        inPipe_1_2_pdest = _RANDOM[8'h49][25:19];
        inPipe_1_2_vecWen = _RANDOM[8'h49][26];
        inPipe_1_2_v0Wen = _RANDOM[8'h49][27];
        inPipe_1_2_fpu_wflags = _RANDOM[8'h49][30];
        inPipe_1_2_vpu_vma = _RANDOM[8'h4A][7];
        inPipe_1_2_vpu_vta = _RANDOM[8'h4A][8];
        inPipe_1_2_vpu_vsew = _RANDOM[8'h4A][10:9];
        inPipe_1_2_vpu_vlmul = _RANDOM[8'h4A][13:11];
        inPipe_1_2_vpu_vm = _RANDOM[8'h4A][22];
        inPipe_1_2_vpu_vstart = _RANDOM[8'h4A][30:23];
        inPipe_1_2_vpu_vuopIdx = _RANDOM[8'h4B][17:11];
        inPipe_1_2_vpu_isNarrow = _RANDOM[8'h50][2];
        inPipe_1_2_vpu_isDstMask = _RANDOM[8'h50][3];
        inPipe_1_3_fuOpType = _RANDOM[8'h64][9:1];
        inPipe_1_3_src_2 =
          {_RANDOM[8'h6C][31:10],
           _RANDOM[8'h6D],
           _RANDOM[8'h6E],
        ...
        inPipe_1_3_src_4 =
          {_RANDOM[8'h74][31:10],
           ...
           _RANDOM[8'h77],
           _RANDOM[8'h78][9:0]};
        inPipe_1_3_robIdx_flag = _RANDOM[8'h7A][10];
        inPipe_1_3_robIdx_value = _RANDOM[8'h7A][18:11];
        inPipe_1_3_pdest = _RANDOM[8'h7A][30:24];
        inPipe_1_3_vecWen = _RANDOM[8'h7A][31];
        inPipe_1_3_v0Wen = _RANDOM[8'h7B][0];
        inPipe_1_3_fpu_wflags = _RANDOM[8'h7B][3];
        inPipe_1_3_vpu_vma = _RANDOM[8'h7B][12];
        inPipe_1_3_vpu_vta = _RANDOM[8'h7B][13];
        inPipe_1_3_vpu_vsew = _RANDOM[8'h7B][15:14];
        inPipe_1_3_vpu_vlmul = _RANDOM[8'h7B][18:16];
        inPipe_1_3_vpu_vm = _RANDOM[8'h7B][27];
        inPipe_1_3_vpu_vstart = {_RANDOM[8'h7B][31:28], _RANDOM[8'h7C][3:0]};
        inPipe_1_3_vpu_vuopIdx = _RANDOM[8'h7C][22:16];
        inPipe_1_3_vpu_isNarrow = _RANDOM[8'h81][7];
        inPipe_1_3_vpu_isDstMask = _RANDOM[8'h81][8];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
  ...
  assign io_out_bits_pdest =
    ...
    | (_Vimac_io_out_valid ? _Vimac_io_out_bits_ctrl_pdest[6:0] : 7'h0)
    | (_Vppu_io_out_valid ? _Vppu_io_out_bits_ctrl_pdest[6:0] : 7'h0);
  ...
  assign io_out_bits_robIdx_value =
    ...
    | (_Vimac_io_out_valid ? _Vimac_io_out_bits_ctrl_robIdx_value : 8'h0)
    | (_Vppu_io_out_valid ? _Vppu_io_out_bits_ctrl_robIdx_value : 8'h0);
