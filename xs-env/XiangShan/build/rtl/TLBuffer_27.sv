...
module TLBuffer_27(
  ...
  Queue2_TLBundleA_33 nodeOut_a_q (
    .clock                      (clock),
    .reset                      (reset),
    ...
    .io_enq_bits_user_alias     (auto_in_0_a_bits_user_alias),
    ...
    .io_deq_bits_user_alias     (auto_out_0_a_bits_user_alias),
  ...
  Queue2_TLBundleD_36 nodeIn_d_q (
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue2_TLBundleC_2 nodeOut_c_q (
    ...
    .io_enq_bits_user_alias     (auto_in_0_c_bits_user_alias),
    ...
    .io_deq_bits_user_alias     (auto_out_0_c_bits_user_alias),
  ...
  Queue2_TLBundleA_33 nodeOut_a_q_1 (
    .clock                      (clock),
    .reset                      (reset),
    ...
    .io_enq_bits_user_alias     (auto_in_1_a_bits_user_alias),
    ...
    .io_deq_bits_user_alias     (auto_out_1_a_bits_user_alias),
  ...
  Queue2_TLBundleD_36 nodeIn_d_q_1 (
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue2_TLBundleB_2 nodeIn_b_q_1 (
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleC_2 nodeOut_c_q_1 (
    .clock                      (clock),
    .reset                      (reset),
    ...
    .io_enq_bits_user_alias     (auto_in_1_c_bits_user_alias),
    ...
    .io_deq_bits_user_alias     (auto_out_1_c_bits_user_alias),
  ...
  Queue2_TLBundleE_2 nodeOut_e_q_1 (
    .clock            (clock),
    .reset            (reset),
  ...
  Queue2_TLBundleA_33 nodeOut_a_q_2 (
    .clock                      (clock),
    .reset                      (reset),
    .io_enq_ready               (auto_in_2_a_ready),
    ...
    .io_enq_bits_user_reqSource (auto_in_2_a_bits_user_reqSource),
    .io_enq_bits_user_alias     (auto_in_2_a_bits_user_alias),
    .io_enq_bits_user_vaddr     (auto_in_2_a_bits_user_vaddr),
    .io_enq_bits_user_needHint  (auto_in_2_a_bits_user_needHint),
    .io_enq_bits_echo_isKeyword (auto_in_2_a_bits_echo_isKeyword),
    ...
    .io_deq_bits_user_reqSource (auto_out_2_a_bits_user_reqSource),
    .io_deq_bits_user_alias     (auto_out_2_a_bits_user_alias),
    .io_deq_bits_user_vaddr     (auto_out_2_a_bits_user_vaddr),
    .io_deq_bits_user_needHint  (auto_out_2_a_bits_user_needHint),
    .io_deq_bits_echo_isKeyword (auto_out_2_a_bits_echo_isKeyword),
  ...
  Queue2_TLBundleD_36 nodeIn_d_q_2 (
    .clock                      (clock),
    .reset                      (reset),
    ...
    .io_enq_bits_echo_isKeyword (auto_out_2_d_bits_echo_isKeyword),
    .io_enq_bits_data           (auto_out_2_d_bits_data),
    .io_enq_bits_corrupt        (auto_out_2_d_bits_corrupt),
    .io_deq_ready               (auto_in_2_d_ready),
    .io_deq_valid               (auto_in_2_d_valid),
    .io_deq_bits_opcode         (auto_in_2_d_bits_opcode),
    .io_deq_bits_param          (auto_in_2_d_bits_param),
    .io_deq_bits_size           (auto_in_2_d_bits_size),
    .io_deq_bits_source         (auto_in_2_d_bits_source),
    .io_deq_bits_sink           (auto_in_2_d_bits_sink),
    .io_deq_bits_denied         (auto_in_2_d_bits_denied),
    .io_deq_bits_echo_isKeyword (auto_in_2_d_bits_echo_isKeyword),
    .io_deq_bits_data           (auto_in_2_d_bits_data),
    .io_deq_bits_corrupt        (auto_in_2_d_bits_corrupt)
  );
  Queue2_TLBundleB_2 nodeIn_b_q_2 (
    .clock               (clock),
    .reset               (reset),
    .io_enq_ready        (auto_out_2_b_ready),
    .io_enq_valid        (auto_out_2_b_valid),
    .io_enq_bits_opcode  (auto_out_2_b_bits_opcode),
    ...
    .io_enq_bits_mask    (auto_out_2_b_bits_mask),
    .io_enq_bits_data    (auto_out_2_b_bits_data),
    .io_enq_bits_corrupt (auto_out_2_b_bits_corrupt),
    .io_deq_ready        (auto_in_2_b_ready),
    .io_deq_valid        (auto_in_2_b_valid),
    .io_deq_bits_opcode  (auto_in_2_b_bits_opcode),
    .io_deq_bits_param   (auto_in_2_b_bits_param),
    .io_deq_bits_size    (auto_in_2_b_bits_size),
    .io_deq_bits_source  (auto_in_2_b_bits_source),
    .io_deq_bits_address (auto_in_2_b_bits_address),
    .io_deq_bits_mask    (auto_in_2_b_bits_mask),
    .io_deq_bits_data    (auto_in_2_b_bits_data),
    .io_deq_bits_corrupt (auto_in_2_b_bits_corrupt)
  );
  Queue2_TLBundleC_2 nodeOut_c_q_2 (
    .clock                      (clock),
    .reset                      (reset),
    .io_enq_ready               (auto_in_2_c_ready),
    ...
    .io_enq_bits_user_reqSource (auto_in_2_c_bits_user_reqSource),
    .io_enq_bits_user_alias     (auto_in_2_c_bits_user_alias),
    .io_enq_bits_user_vaddr     (auto_in_2_c_bits_user_vaddr),
    .io_enq_bits_user_needHint  (auto_in_2_c_bits_user_needHint),
    .io_enq_bits_echo_isKeyword (auto_in_2_c_bits_echo_isKeyword),
    .io_enq_bits_data           (auto_in_2_c_bits_data),
    .io_enq_bits_corrupt        (auto_in_2_c_bits_corrupt),
    ...
    .io_deq_bits_user_reqSource (auto_out_2_c_bits_user_reqSource),
    .io_deq_bits_user_alias     (auto_out_2_c_bits_user_alias),
    .io_deq_bits_user_vaddr     (auto_out_2_c_bits_user_vaddr),
    .io_deq_bits_user_needHint  (auto_out_2_c_bits_user_needHint),
    .io_deq_bits_echo_isKeyword (auto_out_2_c_bits_echo_isKeyword),
    .io_deq_bits_data           (auto_out_2_c_bits_data),
    .io_deq_bits_corrupt        (auto_out_2_c_bits_corrupt)
  );
  Queue2_TLBundleE_2 nodeOut_e_q_2 (
    .clock            (clock),
    .reset            (reset),
    .io_enq_ready     (auto_in_2_e_ready),
    .io_enq_valid     (auto_in_2_e_valid),
    .io_enq_bits_sink (auto_in_2_e_bits_sink),
    .io_deq_ready     (auto_out_2_e_ready),
    .io_deq_valid     (auto_out_2_e_valid),
    .io_deq_bits_sink (auto_out_2_e_bits_sink)
  );
  Queue2_TLBundleA_33 nodeOut_a_q_3 (
    .clock                      (clock),
    .reset                      (reset),
    .io_enq_ready               (auto_in_3_a_ready),
    ...
    .io_enq_bits_user_reqSource (auto_in_3_a_bits_user_reqSource),
    .io_enq_bits_user_alias     (auto_in_3_a_bits_user_alias),
    .io_enq_bits_user_vaddr     (auto_in_3_a_bits_user_vaddr),
    .io_enq_bits_user_needHint  (auto_in_3_a_bits_user_needHint),
    .io_enq_bits_echo_isKeyword (auto_in_3_a_bits_echo_isKeyword),
    ...
    .io_deq_bits_user_reqSource (auto_out_3_a_bits_user_reqSource),
    .io_deq_bits_user_alias     (auto_out_3_a_bits_user_alias),
    .io_deq_bits_user_vaddr     (auto_out_3_a_bits_user_vaddr),
    .io_deq_bits_user_needHint  (auto_out_3_a_bits_user_needHint),
    .io_deq_bits_echo_isKeyword (auto_out_3_a_bits_echo_isKeyword),
  ...
  Queue2_TLBundleD_36 nodeIn_d_q_3 (
    .clock                      (clock),
    .reset                      (reset),
    ...
    .io_enq_bits_echo_isKeyword (auto_out_3_d_bits_echo_isKeyword),
    .io_enq_bits_data           (auto_out_3_d_bits_data),
    .io_enq_bits_corrupt        (auto_out_3_d_bits_corrupt),
    .io_deq_ready               (auto_in_3_d_ready),
    .io_deq_valid               (auto_in_3_d_valid),
    .io_deq_bits_opcode         (auto_in_3_d_bits_opcode),
    .io_deq_bits_param          (auto_in_3_d_bits_param),
    .io_deq_bits_size           (auto_in_3_d_bits_size),
    .io_deq_bits_source         (auto_in_3_d_bits_source),
    .io_deq_bits_sink           (auto_in_3_d_bits_sink),
    .io_deq_bits_denied         (auto_in_3_d_bits_denied),
    .io_deq_bits_echo_isKeyword (auto_in_3_d_bits_echo_isKeyword),
    .io_deq_bits_data           (auto_in_3_d_bits_data),
    .io_deq_bits_corrupt        (auto_in_3_d_bits_corrupt)
  );
  Queue2_TLBundleB_2 nodeIn_b_q_3 (
    .clock               (clock),
    .reset               (reset),
    .io_enq_ready        (auto_out_3_b_ready),
    .io_enq_valid        (auto_out_3_b_valid),
    .io_enq_bits_opcode  (auto_out_3_b_bits_opcode),
    .io_enq_bits_param   (auto_out_3_b_bits_param),
    .io_enq_bits_size    (auto_out_3_b_bits_size),
    .io_enq_bits_source  (auto_out_3_b_bits_source),
    .io_enq_bits_address (auto_out_3_b_bits_address),
    .io_enq_bits_mask    (auto_out_3_b_bits_mask),
    .io_enq_bits_data    (auto_out_3_b_bits_data),
    .io_enq_bits_corrupt (auto_out_3_b_bits_corrupt),
    .io_deq_ready        (auto_in_3_b_ready),
    .io_deq_valid        (auto_in_3_b_valid),
    .io_deq_bits_opcode  (auto_in_3_b_bits_opcode),
    .io_deq_bits_param   (auto_in_3_b_bits_param),
    .io_deq_bits_size    (auto_in_3_b_bits_size),
    .io_deq_bits_source  (auto_in_3_b_bits_source),
    .io_deq_bits_address (auto_in_3_b_bits_address),
    .io_deq_bits_mask    (auto_in_3_b_bits_mask),
    .io_deq_bits_data    (auto_in_3_b_bits_data),
    .io_deq_bits_corrupt (auto_in_3_b_bits_corrupt)
  );
  Queue2_TLBundleC_2 nodeOut_c_q_3 (
    .clock                      (clock),
    .reset                      (reset),
    .io_enq_ready               (auto_in_3_c_ready),
    .io_enq_valid               (auto_in_3_c_valid),
    .io_enq_bits_opcode         (auto_in_3_c_bits_opcode),
    .io_enq_bits_param          (auto_in_3_c_bits_param),
    .io_enq_bits_size           (auto_in_3_c_bits_size),
    .io_enq_bits_source         (auto_in_3_c_bits_source),
    .io_enq_bits_address        (auto_in_3_c_bits_address),
    .io_enq_bits_user_reqSource (auto_in_3_c_bits_user_reqSource),
    .io_enq_bits_user_alias     (auto_in_3_c_bits_user_alias),
    .io_enq_bits_user_vaddr     (auto_in_3_c_bits_user_vaddr),
    .io_enq_bits_user_needHint  (auto_in_3_c_bits_user_needHint),
    .io_enq_bits_echo_isKeyword (auto_in_3_c_bits_echo_isKeyword),
    .io_enq_bits_data           (auto_in_3_c_bits_data),
    .io_enq_bits_corrupt        (auto_in_3_c_bits_corrupt),
    .io_deq_ready               (auto_out_3_c_ready),
    .io_deq_valid               (auto_out_3_c_valid),
    .io_deq_bits_opcode         (auto_out_3_c_bits_opcode),
    .io_deq_bits_param          (auto_out_3_c_bits_param),
    .io_deq_bits_size           (auto_out_3_c_bits_size),
    .io_deq_bits_source         (auto_out_3_c_bits_source),
    .io_deq_bits_address        (auto_out_3_c_bits_address),
    .io_deq_bits_user_reqSource (auto_out_3_c_bits_user_reqSource),
    .io_deq_bits_user_alias     (auto_out_3_c_bits_user_alias),
    .io_deq_bits_user_vaddr     (auto_out_3_c_bits_user_vaddr),
    .io_deq_bits_user_needHint  (auto_out_3_c_bits_user_needHint),
    .io_deq_bits_echo_isKeyword (auto_out_3_c_bits_echo_isKeyword),
    .io_deq_bits_data           (auto_out_3_c_bits_data),
    .io_deq_bits_corrupt        (auto_out_3_c_bits_corrupt)
  );
  Queue2_TLBundleE_2 nodeOut_e_q_3 (
    .clock            (clock),
    .reset            (reset),
    .io_enq_ready     (auto_in_3_e_ready),
    .io_enq_valid     (auto_in_3_e_valid),
    .io_enq_bits_sink (auto_in_3_e_bits_sink),
    .io_deq_ready     (auto_out_3_e_ready),
    .io_deq_valid     (auto_out_3_e_valid),
    .io_deq_bits_sink (auto_out_3_e_bits_sink)
  );
endmodule
