...
module ITTageTable_3(
  ...
  wire [8:0] _update_folded_hist_hist_6_folded_hist_T_1 =
    {io_update_ghist[8:7], io_update_ghist[6:0] ^ io_update_ghist[15:9]};
  wire [8:0] update_idx = io_update_pc[9:1] ^ _update_folded_hist_hist_6_folded_hist_T_1;
  reg        needReset;
  ...
  FoldedSRAMTemplate_23 table_0 (
    ...
    .io_r_req_bits_setIdx
      (io_req_bits_pc[9:1] ^ io_req_bits_folded_hist_hist_6_folded_hist),
    ...
    .io_w_req_bits_data_0_tag
      (io_update_pc[18:10] ^ _update_folded_hist_hist_6_folded_hist_T_1
       ^ {io_update_ghist[7:0] ^ io_update_ghist[15:8], 1'h0}),
