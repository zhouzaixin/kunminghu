  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_1_robIdx_value = {_RANDOM[7'h9][31], _RANDOM[7'hA][6:0]};
        inPipe_1_1_pdest = _RANDOM[7'hA][19:12];
        inPipe_1_1_rfWen = _RANDOM[7'hA][20];
        inPipe_1_1_fpWen = _RANDOM[7'hA][21];
        inPipe_1_1_fpu_wflags = _RANDOM[7'hA][26];
        inPipe_1_2_fuOpType = _RANDOM[7'h1F][9:1];
        inPipe_1_2_robIdx_flag = _RANDOM[7'h27][10];
        inPipe_1_2_robIdx_value = _RANDOM[7'h27][18:11];
        inPipe_1_2_pdest = _RANDOM[7'h27][31:24];
        inPipe_1_2_rfWen = _RANDOM[7'h28][0];
        inPipe_1_2_fpWen = _RANDOM[7'h28][1];
        inPipe_1_2_fpu_wflags = _RANDOM[7'h28][6];
        inPipe_1_3_robIdx_flag = _RANDOM[7'h44][22];
        inPipe_1_3_robIdx_value = _RANDOM[7'h44][30:23];
        inPipe_1_3_pdest = _RANDOM[7'h45][11:4];
        inPipe_1_3_fpWen = _RANDOM[7'h45][13];
        inPipe_1_3_fpu_wflags = _RANDOM[7'h45][18];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
