...
module SRAMTemplate_62(
  ...
  input  [151:0] io_w_req_bits_flattened_bitmask
);
  ...
  reg  [37:0]  rdata_hold_data_2;
  reg  [37:0]  rdata_hold_data_3;
  ...
  wire [37:0]  _rdata_T_2 = rdata_last_REG ? _array_RW0_rdata[113:76] : rdata_hold_data_2;
  wire [37:0]  _rdata_T_3 =
    rdata_last_REG ? _array_RW0_rdata[151:114] : rdata_hold_data_3;
  ...
  always @(posedge clock) begin
    if (rdata_last_REG) begin
      ...
      rdata_hold_data_2 <= _array_RW0_rdata[113:76];
      rdata_hold_data_3 <= _array_RW0_rdata[151:114];
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        rdata_hold_data_0 = {_RANDOM[4'h8][31:28], _RANDOM[4'h9], _RANDOM[4'hA][1:0]};
        rdata_hold_data_1 = {_RANDOM[4'hA][31:2], _RANDOM[4'hB][7:0]};
        rdata_hold_data_2 = {_RANDOM[4'hB][31:8], _RANDOM[4'hC][13:0]};
        rdata_hold_data_3 = {_RANDOM[4'hC][31:14], _RANDOM[4'hD][19:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 7'h0;
  ...
  array_7 array (
    ...
    .RW0_wdata
      ({~_resetState,
        ...
        _resetState ? 20'h0 : io_w_req_bits_data_3_target_offset_offset,
        _resetState ? 4'h0 : io_w_req_bits_data_3_target_offset_pointer,
        ~_resetState & io_w_req_bits_data_3_target_offset_usePCRegion,
        ...
        _resetState ? 20'h0 : io_w_req_bits_data_2_target_offset_offset,
        _resetState ? 4'h0 : io_w_req_bits_data_2_target_offset_pointer,
        ~_resetState & io_w_req_bits_data_2_target_offset_usePCRegion,
    ...
    .RW0_wmask
      (_resetState
         ? 152'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
  ...
  assign io_r_resp_data_2_valid = _rdata_T_2[37];
  assign io_r_resp_data_2_tag = _rdata_T_2[36:28];
  assign io_r_resp_data_2_ctr = _rdata_T_2[27:26];
  assign io_r_resp_data_2_target_offset_offset = _rdata_T_2[25:6];
  assign io_r_resp_data_2_target_offset_pointer = _rdata_T_2[5:2];
  assign io_r_resp_data_2_target_offset_usePCRegion = _rdata_T_2[1];
  assign io_r_resp_data_2_useful = _rdata_T_2[0];
  assign io_r_resp_data_3_valid = _rdata_T_3[37];
  assign io_r_resp_data_3_tag = _rdata_T_3[36:28];
  assign io_r_resp_data_3_ctr = _rdata_T_3[27:26];
  assign io_r_resp_data_3_target_offset_offset = _rdata_T_3[25:6];
  assign io_r_resp_data_3_target_offset_pointer = _rdata_T_3[5:2];
  assign io_r_resp_data_3_target_offset_usePCRegion = _rdata_T_3[1];
