...
module Queue4_DSData(
  ...
  ram_4x257 ram_ext (
    ...
    .W0_en   (do_enq),
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_data})
  );
  assign io_deq_bits_data = empty ? io_enq_bits_data : _ram_ext_R0_data[255:0];
  assign io_deq_bits_corrupt = empty ? io_enq_bits_corrupt : _ram_ext_R0_data[256];
endmodule
