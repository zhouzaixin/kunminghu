...
module TageTable_1(
  ...
  wire [10:0] update_idx =
    io_update_pc[11:1]
    ^ {io_update_ghist[10:2], io_update_ghist[1:0] ^ io_update_ghist[12:11]};
  wire [7:0]  update_tag =
    io_update_pc[8:1]
    ^ {io_update_ghist[7:5], io_update_ghist[4:0] ^ io_update_ghist[12:8]}
    ^ {io_update_ghist[6], io_update_ghist[5:0] ^ io_update_ghist[12:7], 1'h0};
